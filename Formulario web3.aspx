<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/mpPrincipal.master" AutoEventWireup="true" CodeBehind="Formulario web3.aspx.cs" Inherits="wsCheckUsuario.Formulario_web3" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <!-- Pagina para insertar algun alumno-->
    ...
    <table border="0" class="auto-style10">
        <tr>
            <td width="30%" class="auto-style4">
                ...
                <asp:Label ID="Label7" runat="server" Font-Names="Arial" Font-Size="Small" Text="Id Alumno:"></asp:Label>

            </td>
            <td width="70%" class="auto-style4">

                <asp:TextBox ID="TextBox1" runat="server" MaxLength="3" Width="60px"></asp:TextBox>
        ...
        <tr>
            <td colspan="2" align="middle">
                ...
                <asp:Button ID="Button3" runat="server" Text="Eliminar"  CssClass="btn btn-danger" OnClick="Button3_Click" />
                 &nbsp;
                <asp:Button ID="Button4" runat="server" Text="Principal"  CssClass="btn btn-orange" PostBackUrl="~/Formulario web1.aspx"/>
                <br />
            </td>
        </tr>
    </table>
